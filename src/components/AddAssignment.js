    ...
    render() {
        return (
            <div align="left" style={{ margin: "15px" }} >
                ...
                <TextField name="assignName" varint="standard" required label="Assignment Name" style={{display:"block", margin: "10px"}}
                    onChange={this.handleNameChange}> 
                </TextField>
                <TextField name="dueDate" varint="standard" required label="Due Date" style={{ display: "block", margin: "10px" }}
                    onChange={this.handleDueDateChange}>
                </TextField>
                <TextField name="course" varint="standard" required label="Course" style={{ display: "block", margin: "10px" }}
